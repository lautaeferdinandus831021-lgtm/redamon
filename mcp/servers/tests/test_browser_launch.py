...
shared by the whitehat SDK's `whitehat.browser` and (constants only) by
playwright_server.

§20.2 tag-leak guard: the proxy flag and the X-WhiteHat-Ctx header are emitted
