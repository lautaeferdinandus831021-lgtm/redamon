...
const STORAGE_KEY = 'whitehat-github-star-dismissed'
  ...
  return (
    <div className={styles.banner}>
      ...
      <span className={styles.text}>
        Enjoying WhiteHat? A <a href="https://github.com/samugit83/redamon" target="_blank" rel="noopener noreferrer">GitHub star</a> helps others discover the project.
      </span>
