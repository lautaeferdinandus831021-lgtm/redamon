        ...
        {chatItems.length === 0 && (
          <div className={styles.emptyState}>
            <div className={styles.emptyIcon}>
              <img src="/logo.png" alt="WhiteHat" width={72} height={72} style={{ objectFit: 'contain' }} />
            </div>
          ...
          <div className={`${styles.message} ${styles.messageAssistant}`}>
            <div className={`${styles.messageIcon} ${styles.loadingEyeIcon}`}>
              <div className={styles.eyeContainer}>
                <img src="/logo.png" alt="WhiteHat" width={34} height={21} className={styles.loadingEye} ref={eyeRef} />
